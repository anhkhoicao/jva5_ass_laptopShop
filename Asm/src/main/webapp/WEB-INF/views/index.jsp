...
<div class="main-banner" id="top">
  ...
  <div class="carousel-inner">
	...
	<img src="assets/images/slide1.jpg" alt="slide1" class="d-block" style="width:100%">
    </div>
    <div class="carousel-item">
      <img src="assets/images/slide2.jpg" alt="slide2" class="d-block" style="width:100%">
    </div>
    <div class="carousel-item">
      <img src="assets/images/slide3.jpg" alt="slide3" class="d-block" style="width:100%">
    </div>
  </div>
        ...
        <div class="col-sm-12 col-md-6 col-lg-3 mb-4">
            <div class="card h-100">
                ...
                <div class="card-footer d-flex justify-content-between bg-transparent border-0">
                    ...
                    <a href="/product?id=${prod.id}" class="btn btn-outline-dark">Detail</a>
                </div>
            </div>
        </div>
    </c:forEach>
